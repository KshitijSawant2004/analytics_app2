...
export default function DashboardPage() {
  ...
  const loadRecommendations = () => {
    ...
    window.setTimeout(() => {
      const offers = [
        { id: "offer_personal", title: "Personal Loan", amount: "INR 5,00,000" },
        { id: "offer_education", title: "Education Loan", amount: "INR 3,00,000" },
        { id: "offer_vehicle", title: "Vehicle Loan", amount: "INR 7,50,000" },
      ];
